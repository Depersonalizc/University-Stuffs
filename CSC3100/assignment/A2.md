...
![rec](C:\Users\chen1\Documents\University-Stuffs\CSC3100\assignment\rec.svg)

The maximum depth occurs at the leftmost branch
$$
\Theta(n)\to\Theta((1-\alpha)n)\to\Theta((1-\alpha)^2n)\cdots\Theta((1-\alpha)^k n)
$$
